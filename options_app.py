...
<html>
<head>
    <title>Aurelian Options Oracle | AI-Powered Options Intelligence</title>
    <style>
...
<div class="badge">⚡ Real-Time Greeks | 🤖 Claude AI Strategies | 📊 P&L Simulator</div>
    ...
    <!-- FOOTER -->
    <div class="footer">
        <p>Built with Python | Flask | Groq AI | Black-Scholes | Real-time NSE Data</p>
